            ...
            <div class="row justify-content-center">
                ...
                <div class="dropdown col-2">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="mis_publicaciones.php?categoria=Desarrollo tecnologico">Desarrollo tecnologico</a></li>
                        <li><a class="dropdown-item" href="mis_publicaciones.php?categoria=Deportes">Deportes</a></li>
                    </ul>
                </div>
